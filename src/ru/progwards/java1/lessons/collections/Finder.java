...
public class Finder {
    ...
    public static boolean findSequence(Collection<Integer> numbers) {
        for (int i = 1; i < numbers.size(); i++) {
            if (!numbers.contains(i)) { // ищем единственное несовпадение. Если не находим - возвращаем true.
                return false;
            }
        }
        return true;
    ...
    public static String findSimilar(Collection<String> names) {
        ...
        ArrayList<Integer> nTimes = new ArrayList<>();
        System.out.println(arrayListNames);
        String name = "";
        int j = 1;  // количество совпадений для конкретного элемента
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> myStringList = new ArrayList<>(Arrays.asList("Тихон", "Таня", "Тихон", "Тихон", "Толя", "Толя", "Толя", "Таня", "Таня", "Алекс"));
