...
Правильный ответ:
numbers.remove(3); → 0 1 2 4,
numbers.add(Collections.min(numbers)); → 0 1 2 3 4 0,
numbers.add(3, 5); → Компилятор выдаст ошибку,
((ArrayList)numbers).add(3, numbers.size()); → 0 1 2 5 3 4
 */
